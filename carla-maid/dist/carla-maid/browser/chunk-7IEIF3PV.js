...
var BookingService = class _BookingService {
  ...
  createBooking(bookingRequest) {
    ...
    return this.http.post(`${this.backendApiUrl}/book`, orderData).pipe(map(this.handleBookingApiResponse), catchError(this.handleHttpError.bind(this)));
  }
  /**
...
var PaymentDataService = class _PaymentDataService {
   ...
   * @returns Observable with payment data
   */
  getPaymentDataFromMultipleSources(orderId) {
...
//# sourceMappingURL=chunk-7IEIF3PV.js.map
