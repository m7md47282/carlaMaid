...
var routes = [
  ...
  {
    path: "blogs",
    loadComponent: () => import("./chunk-MDGUWWQU.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-67ILLIPP.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
  ...
  {
    path: "book-now",
    loadComponent: () => import("./chunk-2XGXBKVL.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-CQOISRCH.mjs").then((m) => m);
