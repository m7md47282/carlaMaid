...
// src/app/customized-cleaning/customized-cleaning.component.ts
function CustomizedCleaningComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
...
function CustomizedCleaningComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
...
var CustomizedCleaningComponent = class _CustomizedCleaningComponent {
  services = [
  ...
  static \u0275fac = function CustomizedCleaningComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CustomizedCleaningComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CustomizedCleaningComponent, selectors: [["app-customized-cleaning"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 61, vars: 14, consts: [[1, "service-page"], [1, "hero"], [1, "hero-content"], [1, "hero-subtitle"], ["routerLink", "/book-now", 1, "cta-button"], [1, "pi", "pi-calendar"], [1, "hero-overlay"], [1, "services-grid"], [1, "container"], [1, "grid"], ["class", "service-card", 4, "ngFor", "ngForOf"], [1, "whats-included"], [1, "included-grid"], ["class", "included-item", 4, "ngFor", "ngForOf"], [1, "pricing"], [1, "pricing-description"], [1, "pricing-features"], [1, "feature"], [1, "pi", "pi-list"], [1, "pi", "pi-star"], [1, "pi", "pi-check-square"], [1, "cta-section"], ["routerLink", "/book-now", 1, "cta-button", "large"], [1, "pi", "pi-phone"], [1, "service-card"], [1, "icon-wrapper"], [1, "included-item"], [1, "pi", "pi-check-circle"]], template: function CustomizedCleaningComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(17, "Your Cleaning, Your Way");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 9);
      \u0275\u0275template(19, CustomizedCleaningComponent_div_19_Template, 7, 4, "div", 10);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(20, "section", 11)(21, "div", 8)(22, "h2");
      \u0275\u0275text(23, "Personalized Cleaning Solutions");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 12);
      \u0275\u0275template(25, CustomizedCleaningComponent_div_25_Template, 4, 1, "div", 13);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(26, "section", 14)(27, "div", 8)(28, "h2");
      \u0275\u0275text(29, "Build Your Perfect Cleaning Plan");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "p", 15);
      \u0275\u0275text(31, " Create a cleaning package that matches your exact requirements. Choose your tasks, frequency, and add-ons for a truly personalized service. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "div", 16)(33, "div", 17);
      \u0275\u0275element(34, "i", 18);
      \u0275\u0275elementStart(35, "h4");
      \u0275\u0275text(36, "Basic Custom");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "p");
      \u0275\u0275text(38, "3-5 selected tasks");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(39, "div", 17);
      \u0275\u0275element(40, "i", 19);
      \u0275\u0275elementStart(41, "h4");
      \u0275\u0275text(42, "Standard Custom");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "p");
      \u0275\u0275text(44, "6-10 selected tasks");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "div", 17);
      \u0275\u0275element(46, "i", 20);
      \u0275\u0275elementStart(47, "h4");
      \u0275\u0275text(48, "Premium Custom");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "p");
      \u0275\u0275text(50, "Unlimited tasks & extras");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(51, "section", 21)(52, "div", 8)(53, "h2");
      \u0275\u0275text(54, "Design Your Perfect Cleaning Service");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(55, "p");
      \u0275\u0275text(56, "Tell us what you need, and we'll create a customized plan just for you.");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 6, "shared.CustomizedCleaning"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 8, "paragraph.OfferingFlexibleScheduling"));
      \u0275\u0275advance(4);
...
.service-card[_ngcontent-%COMP%]:hover {
  ...
  box-shadow: 0 8px 25px rgba(247, 112, 98, 0.3);
}
...
.pricing[_ngcontent-%COMP%]   .pricing-features[_ngcontent-%COMP%]   .feature[_ngcontent-%COMP%] {
  ...
  background:
    linear-gradient(
      135deg,
      rgba(247, 112, 98, 0.1) 0%,
      rgba(254, 81, 150, 0.1) 100%);
  border-radius: 12px;
  border: 2px solid rgba(247, 112, 98, 0.2);
}
...
/*# sourceMappingURL=customized-cleaning.component.css.map */`] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CustomizedCleaningComponent, { className: "CustomizedCleaningComponent" });
})();
export {
  CustomizedCleaningComponent
};
//# sourceMappingURL=chunk-AM5PCZKD.mjs.map
