...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BlogsOpenComponent, { className: "BlogsOpenComponent", filePath: "src\\app\\blogs-open\\blogs-open.component.ts", lineNumber: 16 });
})();
export {
  BlogsOpenComponent
};
//# sourceMappingURL=chunk-FQROS7F2.mjs.map
