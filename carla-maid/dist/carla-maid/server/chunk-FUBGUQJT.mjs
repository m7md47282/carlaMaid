...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-5GJJNI3D.mjs").then((m) => m.HeaderComponent), import("./chunk-V3M4P4LO.mjs").then((m) => m.FooterComponent), RouterOutlet];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-E2E7OV6F.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
  ...
  {
    path: "book-now",
    loadComponent: () => import("./chunk-WHY4SLE7.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-FUBGUQJT.mjs.map
