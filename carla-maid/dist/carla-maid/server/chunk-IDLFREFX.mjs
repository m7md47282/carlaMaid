...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ViewBlogsComponent, { className: "ViewBlogsComponent", filePath: "src\\app\\view-blogs\\view-blogs.component.ts", lineNumber: 18 });
})();
export {
  ViewBlogsComponent
};
//# sourceMappingURL=chunk-IDLFREFX.mjs.map
