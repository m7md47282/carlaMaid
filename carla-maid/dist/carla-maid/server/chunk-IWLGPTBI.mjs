...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-DTYVLZGZ.mjs").then((m) => m.HeaderComponent), import("./chunk-JKIIUA4T.mjs").then((m) => m.FooterComponent), RouterOutlet];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-NRP23X6V.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
    loadComponent: () => import("./chunk-7Z57QDFN.mjs").then((m) => m.OurServicesComponent)
  },
  {
    path: "blogs",
    loadComponent: () => import("./chunk-TEFZNOCZ.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-CSFUPG5G.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
    loadComponent: () => import("./chunk-JD2VPCBS.mjs").then((m) => m.BlogsOpenComponent)
  },
  {
    path: "book-now",
    loadComponent: () => import("./chunk-7XCD5K65.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-7D4JFU3U.mjs").then((m) => m.ContactUsComponent)
  }
];
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-RXYYP3VU.mjs").then((m) => m);
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-IWLGPTBI.mjs.map
