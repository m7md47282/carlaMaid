...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-JL42Z4CL.mjs").then((m) => m.HeaderComponent), import("./chunk-ZIXEMHYK.mjs").then((m) => m.FooterComponent), RouterOutlet, MatIcon];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-LNJ4XCU6.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
  ...
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-E5GEI3D6.mjs").then((m) => m.ContactUsComponent)
  },
  {
    path: "blogs-list",
