...
import {
  ...
  SharedModule,
  UniqueComponentId
} from "./chunk-Z5WODZTK.mjs";
import {
  ConfigService
} from "./chunk-Q6JBOM2C.mjs";
import {
  RouterLink
...
var LandingComponent_Defer_217_DepsFn = () => [TranslatePipe, NgIf, SlicePipe, RouterLink];
var _c04 = (a0) => ({ "ar": a0 });
...
function LandingComponent_Defer_215_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "button", 118)(11, "span", 31);
    \u0275\u0275text(12);
    \u0275\u0275pipe(13, "translate");
    \u0275\u0275elementEnd()()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("src", ctx_r1.getFirstImage(post_r3.content.rendered), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1._sharedService.stripHtml(post_r3.title.rendered));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind3(8, 5, ctx_r1._sharedService.stripHtml(post_r3.content.rendered), 0, 200), "");
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", ctx_r1._sharedService.stripHtml(post_r3.content.rendered).length > 200);
    \u0275\u0275advance(3);
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-LZDMNJM6.mjs.map
