...
__publicField(_BookNowComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BookNowComponent, selectors: [["app-book-now"]], viewQuery: function BookNowComponent_Query(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const picker_r2 = \u0275\u0275reference(151);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(6, 71, "form.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(9, 73, "form.description"));
    \u0275\u0275advance(2);
    \u0275\u0275property("formGroup", ctx.bookingForm);
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(19, 75, "form.fullName"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(21, 77, "form.fullName"));
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(34, 79, "form.email"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(36, 81, "form.email"));
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(49, 83, "form.address"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(51, 85, "form.address"));
    \u0275\u0275advance(15);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(66, 87, "form.phone"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(68, 89, "form.phone"));
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(81, 91, "form.hours"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(83, 93, "form.hours"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(86, 95, "form.hourOptions.option1"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 8);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(89, 97, "form.hourOptions.option2"));
    \u0275\u0275advance(14);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(103, 99, "form.arrivalTime"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(105, 101, "form.arrivalTime"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(107, 103, "form.arrivalTimeOptions.option1"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(109, 105, "form.arrivalTimeOptions.option1"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(111, 107, "form.arrivalTimeOptions.option2"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(113, 109, "form.arrivalTimeOptions.option2"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(115, 111, "form.arrivalTimeOptions.option3"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(117, 113, "form.arrivalTimeOptions.option3"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(119, 115, "form.arrivalTimeOptions.option4"));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(121, 117, "form.arrivalTimeOptions.option4"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(123, 119, "form.arrivalTimeOptions.option5"))("disabled", ((tmp_29_0 = ctx.bookingForm.get("hours")) == null ? null : tmp_29_0.value) !== 8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(125, 121, "form.arrivalTimeOptions.option5"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", \u0275\u0275pipeBind1(127, 123, "form.arrivalTimeOptions.option6"))("disabled", ((tmp_32_0 = ctx.bookingForm.get("hours")) == null ? null : tmp_32_0.value) !== 8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(129, 125, "form.arrivalTimeOptions.option6"));
    \u0275\u0275advance(19);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(148, 127, "form.arrivalDate"));
    \u0275\u0275advance(2);
    \u0275\u0275property("matDatepicker", picker_r2)("min", ctx.minDate)("max", ctx.maxDate);
    \u0275\u0275advance(13);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(163, 129, "form.materials"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(165, 131, "form.materials"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", true);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(168, 133, "form.materialOptions.option1"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", false);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(171, 135, "form.materialOptions.option2"));
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(183, 137, "form.numberOfCleaners"));
    \u0275\u0275advance(2);
    \u0275\u0275propertyInterpolate("placeholder", \u0275\u0275pipeBind1(185, 139, "form.numberOfCleaners"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 1);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(188, 141, "form.cleanerOptions.option1"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(191, 143, "form.cleanerOptions.option2"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 3);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(194, 145, "form.cleanerOptions.option3"));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", 4);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(197, 147, "form.cleanerOptions.option4"));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(ctx.sent ? 198 : -1);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("", \u0275\u0275pipeBind1(203, 149, "form.priceLabel"), ": ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("", ctx.price, " ");
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", ctx.bookingForm.invalid);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(210, 151, "form.submitButton"));
    \u0275\u0275advance(21);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(231, 153, "steps.step1.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(234, 155, "steps.step1.description"));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(242, 157, "steps.step2.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(245, 159, "steps.step2.description"));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(255, 161, "steps.step3.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(258, 163, "steps.step3.description"));
    \u0275\u0275advance(8);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(266, 165, "steps.step4.title"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(269, 167, "steps.step4.description"));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(279, 169, "shared.CarlaMaidCleaningServices"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(282, 171, "shared.needsHelp"));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(287, 173, "shared.HaveQuestionsBeforeBooking"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(290, 175, "shared.bookNowDesc"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(294, 177, "shared.ContactUsToday"));
  }
}, dependencies: [
  MatSelectModule,
  MatFormField,
...
//# sourceMappingURL=chunk-OTJ2JSUY.mjs.map
