...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-OZW75XET.mjs").then((m) => m.HeaderComponent), import("./chunk-6X4BFDXY.mjs").then((m) => m.FooterComponent), RouterOutlet];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-Q75EIZ7B.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
    loadComponent: () => import("./chunk-I6CQEZMG.mjs").then((m) => m.OurServicesComponent)
  },
  {
    path: "blogs",
    loadComponent: () => import("./chunk-DLLVFEOS.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-K4PZJCGT.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
    loadComponent: () => import("./chunk-UPI7QJLT.mjs").then((m) => m.BlogsOpenComponent)
  },
  {
    path: "book-now",
    loadComponent: () => import("./chunk-6EIDP5C3.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-C7TCSEMS.mjs").then((m) => m.ContactUsComponent)
  }
];
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-PLDWPP6S.mjs").then((m) => m);
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-PEAKFGRL.mjs.map
