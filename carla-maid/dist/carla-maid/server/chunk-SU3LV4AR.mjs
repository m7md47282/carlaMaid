...
// src/app/seasonal-cleaning/seasonal-cleaning.component.ts
function SeasonalCleaningComponent_div_19_Template(rf, ctx) {
  if (rf & 1) {
...
function SeasonalCleaningComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
...
var SeasonalCleaningComponent = class _SeasonalCleaningComponent {
  services = [
  ...
  static \u0275fac = function SeasonalCleaningComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _SeasonalCleaningComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SeasonalCleaningComponent, selectors: [["app-seasonal-cleaning"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 61, vars: 14, consts: [[1, "service-page"], [1, "hero"], [1, "hero-content"], [1, "hero-subtitle"], ["routerLink", "/book-now", 1, "cta-button"], [1, "pi", "pi-calendar"], [1, "hero-overlay"], [1, "services-grid"], [1, "container"], [1, "grid"], ["class", "service-card", 4, "ngFor", "ngForOf"], [1, "whats-included"], [1, "included-grid"], ["class", "included-item", 4, "ngFor", "ngForOf"], [1, "pricing"], [1, "pricing-description"], [1, "pricing-features"], [1, "feature"], [1, "pi", "pi-clock"], [1, "pi", "pi-sync"], [1, "pi", "pi-calendar-times"], [1, "cta-section"], ["routerLink", "/book-now", 1, "cta-button", "large"], [1, "pi", "pi-phone"], [1, "service-card"], [1, "icon-wrapper"], [1, "included-item"], [1, "pi", "pi-check-circle"]], template: function SeasonalCleaningComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(17, "Seasonal Deep Cleaning Services");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "div", 9);
      \u0275\u0275template(19, SeasonalCleaningComponent_div_19_Template, 7, 4, "div", 10);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(20, "section", 11)(21, "div", 8)(22, "h2");
      \u0275\u0275text(23, "Thorough Seasonal Care");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 12);
      \u0275\u0275template(25, SeasonalCleaningComponent_div_25_Template, 4, 1, "div", 13);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(26, "section", 14)(27, "div", 8)(28, "h2");
      \u0275\u0275text(29, "Seasonal Cleaning Packages");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "p", 15);
      \u0275\u0275text(31, " Prepare your home for each season with our comprehensive cleaning services. Perfect for spring renewal, summer prep, or holiday readiness. ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "div", 16)(33, "div", 17);
      \u0275\u0275element(34, "i", 18);
      \u0275\u0275elementStart(35, "h4");
      \u0275\u0275text(36, "Single Season");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "p");
      \u0275\u0275text(38, "One-time deep clean");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "p");
      \u0275\u0275text(44, "Spring & Fall cleaning");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(49, "p");
      \u0275\u0275text(50, "Year-round coverage");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(51, "section", 21)(52, "div", 8)(53, "h2");
      \u0275\u0275text(54, "Welcome Every Season with a Fresh Home");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(55, "p");
      \u0275\u0275text(56, "Book your seasonal cleaning today and enjoy a thoroughly cleaned home all year long.");
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(5, 6, "shared.SeasonalCleaningServices"));
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 8, "paragraph.EnjoyThoroughSeasonal"));
      \u0275\u0275advance(4);
...
/*# sourceMappingURL=seasonal-cleaning.component.css.map */`] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SeasonalCleaningComponent, { className: "SeasonalCleaningComponent" });
})();
export {
  SeasonalCleaningComponent
};
//# sourceMappingURL=chunk-SU3LV4AR.mjs.map
