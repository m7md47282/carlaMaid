...
__publicField(_BlogsOpenComponent, "\u0275cmp", /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BlogsOpenComponent, selectors: [["app-blogs-open"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 155, vars: 150, consts: [[1, "section-1", "center", "flex-column"], [1, "text-align-center", "hero-title"], [1, "section-2", "flex-column", "page-container", 3, "ngClass"], [1, "gray-text-color"], [1, "primary-text-color"], [1, "primary-text-color", "margin-top50"], [1, "margin-top30"], [1, "mid-page"], ["src", "../../assets/images/blogs-mid-Page.png", "alt", "", 1, "width-100"], [1, "margin-top30", "primary-text-color"], [1, "center", "gap-30", "margin-top50"], ["src", "../../assets/images/blog-img1.png", "alt", "", 1, "width-50"], ["src", "../../assets/images/blog-img2.png", "alt", "", 1, "width-50"], [1, "margin-top30", "gray-text-color"], [1, "gray-text-color", "margin-bottom50"]], template: function BlogsOpenComponent_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("2.1 ", \u0275\u0275pipeBind1(22, 62, "shared.TrainedAndSkilledCleaningStaff"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(25, 64, "paragraph.AleadingCleaningCompanyEmploysTrained"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("2.2 ", \u0275\u0275pipeBind1(28, 66, "shared.UseOfEcoFriendlyCleaningProducts"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(31, 68, "paragraph.EcoFriendlyCleaningHasBecome"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("2.3 ", \u0275\u0275pipeBind1(34, 70, "shared.FlexibleSchedulingAndCustomization"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(37, 72, "paragraph.TheBestCleaningCompaniesOfferFlexible"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("2.4 ", \u0275\u0275pipeBind1(40, 74, "shared.TransparentAndAffordablePricing"), "");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("3.1 ", \u0275\u0275pipeBind1(51, 80, "shared.ResidentialCleaning"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(54, 82, "paragraph.ResidentialCleaningServicesCoverEveryCorner"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("3.2 ", \u0275\u0275pipeBind1(57, 84, "shared.CommercialAndOfficeCleaning"), "");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(60, 86, "paragraph.BusinessesInQatarRelyOnProfessionalCleaning"));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1("3.3 ", \u0275\u0275pipeBind1(63, 88, "shared.EventAndHospitalityCleaning"), "");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate1("1. ", \u0275\u0275pipeBind1(74, 94, "shared.Time-Saving:"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(76, 96, "paragraph.ProfessionalCleaningAllowsYouToFocus"), "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("2. ", \u0275\u0275pipeBind1(80, 98, "shared.ImprovedHealthAndHygiene"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(82, 100, "paragraph.ExpertCleaningReducesAllergens"), "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("3. ", \u0275\u0275pipeBind1(86, 102, "shared.EnhancedAppearance"), ":");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(88, 104, "paragraph.RegularCleaningImprovesTheAesthetic"));
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("4. ", \u0275\u0275pipeBind1(92, 106, "shared.ExtendedPropertyLife"), ":");
    \u0275\u0275advance(2);
...
//# sourceMappingURL=chunk-UPI7QJLT.mjs.map
