...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-UJTT4AJL.mjs").then((m) => m.HeaderComponent), import("./chunk-UUDQO6KL.mjs").then((m) => m.FooterComponent), RouterOutlet];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-XMUG5XE2.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
    loadComponent: () => import("./chunk-JQ6WZGZW.mjs").then((m) => m.OurServicesComponent)
  },
  {
    path: "blogs",
    loadComponent: () => import("./chunk-CUG5IOQ2.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-XNW2G5A3.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
    loadComponent: () => import("./chunk-KHZMXHGX.mjs").then((m) => m.BlogsOpenComponent)
  },
  {
    path: "book-now",
    loadComponent: () => import("./chunk-NZUBCW5D.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-RNMBDKMO.mjs").then((m) => m.ContactUsComponent)
  },
  {
    path: "blogs-list",
    loadComponent: () => import("./chunk-7MLSZFQK.mjs").then((m) => m.BlogsListComponent)
  },
  {
    path: "view-blogs/:id",
    loadComponent: () => import("./chunk-AHA4KK25.mjs").then((m) => m.ViewBlogsComponent)
  }
];
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-VVHVD2WZ.mjs.map
