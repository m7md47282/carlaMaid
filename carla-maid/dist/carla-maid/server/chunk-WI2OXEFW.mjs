...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-JL42Z4CL.mjs").then((m) => m.HeaderComponent), import("./chunk-TBOEHII4.mjs").then((m) => m.FooterComponent), RouterOutlet, MatIcon];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-AQD77KRE.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
    loadComponent: () => import("./chunk-IXJ2EGF4.mjs").then((m) => m.OurServicesComponent)
  },
  {
    path: "blogs",
    loadComponent: () => import("./chunk-QET3FB7F.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-RJY62VO4.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
    loadComponent: () => import("./chunk-CDTKIZNC.mjs").then((m) => m.BlogsOpenComponent)
  },
  {
    path: "book-now",
    loadComponent: () => import("./chunk-R7HGWTZD.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-TEPDL4CY.mjs").then((m) => m.ContactUsComponent)
  },
  {
    path: "blogs-list",
    loadComponent: () => import("./chunk-HET34EQX.mjs").then((m) => m.BlogsListComponent)
  },
  {
    path: "view-blogs/:id",
    loadComponent: () => import("./chunk-7QUJ5TSS.mjs").then((m) => m.ViewBlogsComponent)
  }
];
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-WI2OXEFW.mjs.map
