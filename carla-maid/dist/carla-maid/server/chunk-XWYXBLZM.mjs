...
var AppComponent_Defer_2_DepsFn = () => [import("./chunk-K5JA73XQ.mjs").then((m) => m.HeaderComponent), import("./chunk-YDECCZWR.mjs").then((m) => m.FooterComponent), RouterOutlet, MatIcon];
...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-XGHJH4XJ.mjs").then((m) => m.LandingComponent)
  },
  {
    path: "our-services",
    loadComponent: () => import("./chunk-6JXSDITU.mjs").then((m) => m.OurServicesComponent)
  },
  {
    path: "services/maid-services",
    loadComponent: () => import("./chunk-X67W2WAV.mjs").then((m) => m.MaidServicesComponent)
  },
  {
    path: "services/deep-cleaning",
    loadComponent: () => import("./chunk-AZS5XHP4.mjs").then((m) => m.DeepCleaningComponent)
  },
  {
    path: "services/carpet-cleaning",
    loadComponent: () => import("./chunk-UR46TCPG.mjs").then((m) => m.CarpetCleaningComponent)
  },
  {
    path: "services/event-cleaning",
    loadComponent: () => import("./chunk-ARHIJXX2.mjs").then((m) => m.EventCleaningComponent)
  },
  {
    path: "services/hospitality-staff",
    loadComponent: () => import("./chunk-PG5PEWY6.mjs").then((m) => m.HospitalityStaffComponent)
  },
  {
    path: "services/office-cleaning",
    loadComponent: () => import("./chunk-UFMNIPDB.mjs").then((m) => m.OfficeCleaningComponent)
  },
  {
    path: "services/home-cleaning",
    loadComponent: () => import("./chunk-YAVLENJR.mjs").then((m) => m.HomeCleaningComponent)
  },
  {
    path: "services/eco-friendly-cleaning",
    loadComponent: () => import("./chunk-HYVQBHA6.mjs").then((m) => m.EcoFriendlyCleaningComponent)
  },
  {
    path: "services/housekeeping-services",
    loadComponent: () => import("./chunk-3ZB7IRP4.mjs").then((m) => m.HousekeepingServicesComponent)
  },
  {
    path: "services/staffing-for-businesses",
    loadComponent: () => import("./chunk-WI73FP3E.mjs").then((m) => m.StaffingForBusinessesComponent)
  },
  {
    path: "services/customized-cleaning",
    loadComponent: () => import("./chunk-AM5PCZKD.mjs").then((m) => m.CustomizedCleaningComponent)
  },
  {
    path: "services/seasonal-cleaning",
    loadComponent: () => import("./chunk-SU3LV4AR.mjs").then((m) => m.SeasonalCleaningComponent)
  },
  {
    path: "blogs",
    loadComponent: () => import("./chunk-DSRBMF3V.mjs").then((m) => m.BlogsComponent)
  },
  {
    path: "about-us",
    loadComponent: () => import("./chunk-IZXPQTBB.mjs").then((m) => m.AboutUSComponent)
  },
  {
    path: "blogs-open",
    loadComponent: () => import("./chunk-4NWQ5PCG.mjs").then((m) => m.BlogsOpenComponent)
  },
  {
    path: "book-now",
    loadComponent: () => import("./chunk-RSXA3COP.mjs").then((m) => m.BookNowComponent)
  },
  {
    path: "quotation-request",
    loadComponent: () => import("./chunk-MOQARGH6.mjs").then((m) => m.QuotationRequestComponent)
  },
  {
    path: "book-now/success",
    loadComponent: () => import("./chunk-KLM5UHE6.mjs").then((m) => m.PaymentSuccessComponent)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-TSDRZWZI.mjs").then((m) => m.PaymentCancelComponent)
  },
  {
    path: "payment/cancel",
    loadComponent: () => import("./chunk-TSDRZWZI.mjs").then((m) => m.PaymentCancelComponent)
  ...
  {
    path: "contact-us",
    loadComponent: () => import("./chunk-JE6QDZ2B.mjs").then((m) => m.ContactUsComponent)
  },
  {
    path: "blogs-list",
    loadComponent: () => import("./chunk-WL3FULVD.mjs").then((m) => m.BlogsListComponent)
  },
  {
    path: "view-blogs/:id",
    loadComponent: () => import("./chunk-TISQG2FD.mjs").then((m) => m.ViewBlogsComponent)
  }
];
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-OO5T3QT5.mjs").then((m) => m);
...
@angular/service-worker/fesm2022/service-worker.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-XWYXBLZM.mjs.map
